...
%textt='A double limit cycle of the R{\"{o}}ssler system';
...
text('Interpreter','latex','String','\( c = 3\)','Position',[4,4.5],'FontSize',bf)
axis([-6 8 -7 6])
print -dpdf roessler3bw
print -deps /Users/kevin/papers/math/roessler3bw
